...
int main(int argc, char *argv[]) {
  ...
  /* Test Start: Ziyang - C++ python embedding" */
//  int a = system("bash /home/zjiao04/simplessd-standalone/runpy.sh");
//  a = a + 1;
//
//  std::ifstream file("/home/zjiao04/simplessd-standalone/256GB_LiveMapsBackEnd.ambertrace.ec");
//  std::string line;
//  std::string tmp;
//  if (file.is_open()) {
...
//      file.close();
//  }
//  std::cout << "line read start" << std::endl;
//  std::cout << line << std::endl;
//  std::cout << "line read end" << std::endl;
//
...
//  std::cout << "The number of blocks from ec log: " << cnt << std::endl;
  /* Test End: Ziyang - C++ python embedding" */
  ...
  auto ssdConfig = initSimpleSSDEngine(&engine, pDebugLog, pDebugLog, argv[2]); // argv[2] is ssd configuration file
